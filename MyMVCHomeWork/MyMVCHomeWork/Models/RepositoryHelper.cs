namespace MyMVCHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CusBankContactQtyRepository Getvw_CusBankContactQtyRepository()
		{
			var repository = new vw_CusBankContactQtyRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CusBankContactQtyRepository Getvw_CusBankContactQtyRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CusBankContactQtyRepository();
