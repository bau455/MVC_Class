...
namespace MyMVCHomeWork.Controllers
{
    public class ContactController : Controller
    {
        ...
        private 客戶聯絡人Repository ContRepo = RepositoryHelper.Get客戶聯絡人Repository();
        ...
        public ActionResult Index()
        {
            ...
            var 客戶聯絡人 = ContRepo.All().Include(客 => 客.客戶資料);
        ...
        public ActionResult Details(int? id)
        {
            ...
            客戶聯絡人 客戶聯絡人 = ContRepo.GetCusContactByContactID(id);  // db.客戶聯絡人.Find(id);
            if (客戶聯絡人 == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include="Id,客戶Id,職稱,姓名,Email,手機,電話,IsDelete")] 客戶聯絡人 客戶聯絡人)
        {
            ...
            ViewBag.客戶Id = new SelectList(CusRepo.All(), "Id", "客戶名稱", 客戶聯絡人.客戶Id);
            return View(客戶聯絡人);
        }
        ...
        public ActionResult Edit([Bind(Include="Id,客戶Id,職稱,姓名,Email,手機,電話,IsDelete")] 客戶聯絡人 客戶聯絡人)
        {
            if (ModelState.IsValid)
            {
                ...
                //db.SaveChanges();
                ContRepo.UnitOfWork.Context.Entry(客戶聯絡人).State = EntityState.Modified;
                ContRepo.UnitOfWork.Commit();
                return RedirectToAction("Index");
            }
            ViewBag.客戶Id = new SelectList(CusRepo.All(), "Id", "客戶名稱", 客戶聯絡人.客戶Id);
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            客戶聯絡人 客戶聯絡人 = ContRepo.GetCusContactByContactID(id);
            客戶聯絡人.IsDelete = true;
            ContRepo.UnitOfWork.Commit();
